...
final class ServiceSpecNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return \is_object($data) && $data::class === \Docker\API\Model\ServiceSpec::class;
    }
