...
final class SubnetStatusNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === \Docker\API\Model\SubnetStatus::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && $data::class === \Docker\API\Model\SubnetStatus::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('IPsInUse', $data)) {
            $object->setIPsInUse($data['IPsInUse']);
        }
        if (\array_key_exists('DynamicIPsAvailable', $data)) {
