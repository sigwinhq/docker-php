...
final class NetworkConnectRequestNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === \Docker\API\Model\NetworkConnectRequest::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && $data::class === \Docker\API\Model\NetworkConnectRequest::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Docker\API\Model\NetworkConnectRequest();
    ...
    {
        return [\Docker\API\Model\NetworkConnectRequest::class => false];
    }
}
