...
final class DeviceMappingNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return \is_object($data) && $data::class === \Docker\API\Model\DeviceMapping::class;
    }
