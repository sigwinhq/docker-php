...
final class Client extends Runtime\Client\Client
{
     ...
     *
     * @return ($fetch is 'object' ? null|Model\ContainerSummary[] : \Psr\Http\Message\ResponseInterface)
     *
    ...
    /**
     * @param Model\ContainersCreatePostBody $body            Container to create
     * @param array                          $queryParameters {
     *
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\ContainerCreateResponse : \Psr\Http\Message\ResponseInterface)
     *
    ...
    {
        return $this->executeEndpoint(new Endpoint\ContainerCreate($body, $queryParameters), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\ContainerInspectResponse : \Psr\Http\Message\ResponseInterface)
     *
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\ContainerTopResponse : \Psr\Http\Message\ResponseInterface)
     *
    ...
    {
        return $this->executeEndpoint(new Endpoint\ContainerTop($id, $queryParameters), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\ContainerLogs($id, $queryParameters), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\FilesystemChange[] : \Psr\Http\Message\ResponseInterface)
     *
     ...
     * @return ($fetch is 'object' ? null : \Psr\Http\Message\ResponseInterface)
     *
     * @throws Exception\ContainerExportInternalServerErrorException
    ...
    {
        return $this->executeEndpoint(new Endpoint\ContainerExport($id), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\ContainerStatsResponse : \Psr\Http\Message\ResponseInterface)
     *
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\ContainerUpdateResponse : \Psr\Http\Message\ResponseInterface)
     *
    ...
    {
        return $this->executeEndpoint(new Endpoint\ContainerUpdate($id, $update), $fetch);
    }
     ...
     * @return ($fetch is 'object' ? null : \Psr\Http\Message\ResponseInterface)
     *
     * @throws Exception\ContainerAttachBadRequestException
     * @throws Exception\ContainerAttachInternalServerErrorException
    ...
    {
        return $this->executeEndpoint(new Endpoint\ContainerAttach($id, $queryParameters), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\ContainerAttachWebsocket($id, $queryParameters), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\ContainerWaitResponse : \Psr\Http\Message\ResponseInterface)
     *
     ...
     * @return ($fetch is 'object' ? null : \Psr\Http\Message\ResponseInterface)
     *
     * @throws Exception\ContainerArchiveBadRequestException
     * @throws Exception\ContainerArchiveInternalServerErrorException
    ...
    {
        return $this->executeEndpoint(new Endpoint\ContainerArchive($id, $queryParameters), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\ContainerArchiveInfo($id, $queryParameters), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\PutContainerArchive($id, $inputStream, $queryParameters), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\ContainersPrunePostResponse200 : \Psr\Http\Message\ResponseInterface)
     *
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\ImageSummary[] : \Psr\Http\Message\ResponseInterface)
     *
     ...
     *
     * @param \Psr\Http\Message\StreamInterface|resource|string $inputStream     a tar archive compressed with one of the following algorithms: identity (no compression), gzip, bzip2, xz
     * @param array                                             $queryParameters {
     *
     ...
     * @var string $outputs BuildKit output configuration in the format of a stringified JSON array of objects.
    ...
    {
        return $this->executeEndpoint(new Endpoint\ImageBuild($inputStream, $queryParameters, $headerParameters), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\BuildPrunePostResponse200 : \Psr\Http\Message\ResponseInterface)
     *
    ...
    {
        return $this->executeEndpoint(new Endpoint\ImageCreate($inputImage, $queryParameters, $headerParameters), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\ImageInspect : \Psr\Http\Message\ResponseInterface)
     *
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\ImageHistoryResponseItem[] : \Psr\Http\Message\ResponseInterface)
     *
    ...
    {
        return $this->executeEndpoint(new Endpoint\ImagePush($name, $queryParameters, $headerParameters), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\ImageTag($name, $queryParameters), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\ImageDeleteResponseItem[] : \Psr\Http\Message\ResponseInterface)
     *
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\ImagesSearchGetResponse200Item[] : \Psr\Http\Message\ResponseInterface)
     *
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\ImagesPrunePostResponse200 : \Psr\Http\Message\ResponseInterface)
     *
     ...
     *
     * @param Model\AuthConfig $authConfig Authentication to check
     * @param string           $fetch      Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\AuthResponse : \Psr\Http\Message\ResponseInterface)
     *
    ...
    {
        return $this->executeEndpoint(new Endpoint\SystemAuth($authConfig), $fetch);
    }

    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\SystemInfo : \Psr\Http\Message\ResponseInterface)
     *
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\SystemVersion : \Psr\Http\Message\ResponseInterface)
     *
     ...
     * @return ($fetch is 'object' ? null : \Psr\Http\Message\ResponseInterface)
     *
     * @throws Exception\SystemPingInternalServerErrorException
     */
     ...
     * @return ($fetch is 'object' ? null : \Psr\Http\Message\ResponseInterface)
     *
     * @throws Exception\SystemPingHeadInternalServerErrorException
     */
    ...
    /**
     * @param Model\ContainerConfig $containerConfig The container configuration
     * @param array                 $queryParameters {
     *
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\IDResponse : \Psr\Http\Message\ResponseInterface)
     *
    ...
    {
        return $this->executeEndpoint(new Endpoint\ImageCommit($containerConfig, $queryParameters), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\EventMessage : \Psr\Http\Message\ResponseInterface)
     *
     ...
     * @var bool  $verbose Show detailed information on space usage.
     *
     * }
     *
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\SystemDfGetResponse200 : \Psr\Http\Message\ResponseInterface)
     *
    ...
    {
        return $this->executeEndpoint(new Endpoint\SystemDataUsage($queryParameters), $fetch);
    }
     ...
     * @return ($fetch is 'object' ? null : \Psr\Http\Message\ResponseInterface)
     *
     * @throws Exception\ImageGetInternalServerErrorException
     */
     ...
     * @return ($fetch is 'object' ? null : \Psr\Http\Message\ResponseInterface)
     *
     * @throws Exception\ImageGetAllInternalServerErrorException
     */
    ...
    {
        return $this->executeEndpoint(new Endpoint\ImageLoad($imagesTarball, $queryParameters), $fetch);
    }
     ...
     * @param Model\ContainersIdExecPostBody $execConfig Exec configuration
     * @param string                         $fetch      Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\IDResponse : \Psr\Http\Message\ResponseInterface)
     *
    ...
    {
        return $this->executeEndpoint(new Endpoint\ContainerExec($id, $execConfig), $fetch);
    }
     ...
     * @return ($fetch is 'object' ? null : \Psr\Http\Message\ResponseInterface)
     *
     * @throws Exception\ExecStartConflictException
     * @throws Exception\ExecStartNotFoundException
     */
    public function execStart(string $id, Model\ExecIdStartPostBody $execStartConfig, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\ExecStart($id, $execStartConfig), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\ExecResize($id, $queryParameters), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\ExecIdJsonGetResponse200 : \Psr\Http\Message\ResponseInterface)
     *
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\VolumeListResponse : \Psr\Http\Message\ResponseInterface)
     *
    ...
    /**
     * @param Model\VolumeCreateRequest $volumeConfig Volume configuration
     * @param string                    $fetch        Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\Volume : \Psr\Http\Message\ResponseInterface)
     *
     * @throws Exception\VolumeCreateInternalServerErrorException
     */
    public function volumeCreate(Model\VolumeCreateRequest $volumeConfig, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\VolumeCreate($volumeConfig), $fetch);
    }
     ...
     * @param Model\VolumesNamePutBody $body            The spec of the volume to update. Currently, only Availability may
    ...
    {
        return $this->executeEndpoint(new Endpoint\VolumeUpdate($name, $body, $queryParameters), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\VolumesPrunePostResponse200 : \Psr\Http\Message\ResponseInterface)
     *
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\NetworkSummary[] : \Psr\Http\Message\ResponseInterface)
     *
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\NetworkInspect : \Psr\Http\Message\ResponseInterface)
     *
    ...
    /**
     * @param Model\NetworksCreatePostBody $networkConfig Network configuration
     * @param string                       $fetch         Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\NetworkCreateResponse : \Psr\Http\Message\ResponseInterface)
     *
    ...
    {
        return $this->executeEndpoint(new Endpoint\NetworkCreate($networkConfig), $fetch);
    }
     ...
     */
    public function networkConnect(string $id, Model\NetworkConnectRequest $container, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\NetworkConnect($id, $container), $fetch);
    }
     ...
     */
    public function networkDisconnect(string $id, Model\NetworkDisconnectRequest $container, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\NetworkDisconnect($id, $container), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\NetworksPrunePostResponse200 : \Psr\Http\Message\ResponseInterface)
     *
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\Plugin[] : \Psr\Http\Message\ResponseInterface)
     *
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\PluginPrivilege[] : \Psr\Http\Message\ResponseInterface)
     *
    ...
    {
        return $this->executeEndpoint(new Endpoint\GetPluginPrivileges($queryParameters), $fetch);
    }
     ...
     *
     * @param Model\PluginPrivilege[] $body
     * @param array                   $queryParameters {
     *
    ...
    {
        return $this->executeEndpoint(new Endpoint\PluginPull($body, $queryParameters, $headerParameters), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\PluginInspect($name), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\PluginDelete($name, $queryParameters), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\PluginEnable($name, $queryParameters), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\PluginDisable($name, $queryParameters), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\PluginUpgrade($name, $body, $queryParameters, $headerParameters), $fetch);
    }

    /**
     * @param \Psr\Http\Message\StreamInterface|resource|string $tarContext      Path to tar containing plugin rootfs and manifest
     * @param array                                             $queryParameters {
     *
    ...
    {
        return $this->executeEndpoint(new Endpoint\PluginCreate($tarContext, $queryParameters), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\PluginPush($name), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\PluginSet($name, $body), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\Node[] : \Psr\Http\Message\ResponseInterface)
     *
    ...
    {
        return $this->executeEndpoint(new Endpoint\NodeList($queryParameters), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\NodeDelete($id, $queryParameters), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\NodeInspect($id), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\NodeUpdate($id, $body, $queryParameters), $fetch);
    }

    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\Swarm : \Psr\Http\Message\ResponseInterface)
     *
    ...
    {
        return $this->executeEndpoint(new Endpoint\SwarmInspect(), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\SwarmInit($body), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\SwarmJoin($body), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\SwarmLeave($queryParameters), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\SwarmUpdate($body, $queryParameters), $fetch);
    }

    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\SwarmUnlockkeyGetResponse200 : \Psr\Http\Message\ResponseInterface)
     *
    ...
    {
        return $this->executeEndpoint(new Endpoint\SwarmUnlockkey(), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\SwarmUnlock($body), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\Service[] : \Psr\Http\Message\ResponseInterface)
     *
    ...
    {
        return $this->executeEndpoint(new Endpoint\ServiceList($queryParameters), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\ServiceCreateResponse : \Psr\Http\Message\ResponseInterface)
     *
    ...
    {
        return $this->executeEndpoint(new Endpoint\ServiceCreate($body, $headerParameters), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\ServiceDelete($id), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\ServiceInspect($id, $queryParameters), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\ServiceUpdateResponse : \Psr\Http\Message\ResponseInterface)
     *
    ...
    {
        return $this->executeEndpoint(new Endpoint\ServiceUpdate($id, $body, $queryParameters, $headerParameters), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\ServiceLogs($id, $queryParameters), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\TaskLogs($id, $queryParameters), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\Secret[] : \Psr\Http\Message\ResponseInterface)
     *
    ...
    {
        return $this->executeEndpoint(new Endpoint\SecretCreate($body), $fetch);
    }
     ...
     * @param Model\SecretSpec $body            The spec of the secret to update. Currently, only the Labels field
    ...
    {
        return $this->executeEndpoint(new Endpoint\SecretUpdate($id, $body, $queryParameters), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\Config[] : \Psr\Http\Message\ResponseInterface)
     *
    ...
    {
        return $this->executeEndpoint(new Endpoint\ConfigCreate($body), $fetch);
    }
     ...
     * @param Model\ConfigSpec $body            The spec of the config to update. Currently, only the Labels field
     *                                          can be updated. All other fields must remain unchanged from the
    ...
    {
        return $this->executeEndpoint(new Endpoint\ConfigUpdate($id, $body, $queryParameters), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|Model\DistributionInspect : \Psr\Http\Message\ResponseInterface)
     *
     ...
     * @return ($fetch is 'object' ? null : \Psr\Http\Message\ResponseInterface)
     *
     * @throws Exception\SessionBadRequestException
     * @throws Exception\SessionInternalServerErrorException
     */
